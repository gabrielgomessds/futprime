...
<head>
    ...
    <title>FutPrime - Cadastro de Cliente</title>
...
<nav class="navbar navbar-expand-lg content_bar p-3">
  ...
  <!-- ============================ MENU =============================================== -->
  <nav class="menu_home border-bottom">
    <ul class="nav nav-pills justify-content-center p-3 list_menu">
      ...
      <li class="nav-item ">
        <a class="nav-link active item_mobile" href="#"><i class='bx bxs-user-circle' ></i> <span>Cadastro</span></a>
      </li>
      <li class="nav-item ">
        <a class="nav-link item_mobile" href="../../index.html#form-contact"><i class='bx bxs-envelope' ></i> <span>Contato</span></a>
      </li>
      <li class="nav-item ">
        <a class="nav-link item_mobile" href="login.html"><i class='bx bx-user' ></i> <span>Login</span></a>
      </li>
   ...
   <!-- ============================= MENU RESPONSIVO ===================================== -->
    ...
    <div class="container p-4 mt-4 mb-4 rounded form_signup">
        <form>
            <legend class="color_orange text-center fs-4 fw-bold"> Formulario de cadastro</legend>
            <p class="text-center fst-italic text-danger fw-bold" style="font-size: 14px;">Campos com o (*) são obrigatórios</p>
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label label_form">Digite sua nome: <span class="text-danger fw-bold fs-5">*</span></label>
              <input type="text" class="form-control" placeholder="Digite seu nome completo">
            </div>
            <div class="mb-3">
              <label for="exampleInputEmail1" class="form-label label_form">Digite sua email: <span class="text-danger fw-bold fs-5">*</span></label>
              <input type="email" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp" placeholder="Digite seu email: exemplo@email.com">
            </div>
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label label_form">Digite sua senha: <span class="text-danger fw-bold fs-5">*</span></label>
              <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Digite sua senha, no minimo 6 caracteres">
            </div>
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label label_form">Digite sua senha novamente: <span class="text-danger fw-bold fs-5">*</span></label>
              <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Digite seu senha novamente">
            </div>
            <div class="mb-3">
              <label for="exampleInputPassword1" class="form-label label_form">Digite seu telfone(Whatsapp): </label>
              <input type="password" class="form-control" id="exampleInputPassword1" placeholder="Digite seu telefone: (00) 0 0000-0000">
            </div>
            <label for="exampleInputPassword1" class="form-label label_form">Sexo: <span class="text-danger fw-bold fs-5">*</span></label>

            <div class="form-check">
                <input class="form-check-input select_radio" type="radio" name="exampleRadios" id="exampleRadios1" value="option1" checked>
                <label class="form-check-label label_form" for="exampleRadios1">
                  Masculino
                </label>
              </div>
              <div class="form-check">
                <input class="form-check-input select_radio" type="radio" name="exampleRadios" id="exampleRadios2" value="option2">
                <label class="form-check-label label_form" for="exampleRadios2">
                  Feminino
                </label>
              </div>
              <div class="form-check mb-3">
                <input class="form-check-input select_radio" type="radio" name="exampleRadios" id="exampleRadios3" value="option3">
                <label class="form-check-label label_form" for="exampleRadios3">
                  Outro
                </label>
              </div>
            <button type="submit" class="btn bg_darkorange text-light">Cadastrar</button>
        </form>
    </div>
